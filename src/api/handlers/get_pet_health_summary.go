...
// GetPetHealthSummary повертає короткий опис обраної тварини власника
...
// createPetHealthSummary створює короткий опис здоров'я тварини
...
// analyzeTemperature аналізує температуру
...
// analyzeActivity аналізує активність
...
// calculateHealthScore розраховує загальний бал здоров'я
...
// determineOverallStatus визначає загальний стан здоров'я
